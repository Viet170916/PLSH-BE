...
namespace Common.Library
{
    ...
    public static class Constants
    {
        ...
        public static readonly string ApplicationExcel = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        ...
        public static class ErrorMessages
        {
            ...
            public static readonly string TaggingEntityExistedPrimary = "The Tagging Entity and engagement code already exist";
        ...
        public static class UrlConst
        {
            ...
            public static readonly string GetBookingRequestDailyFactorOverview = "api/booking/booking-request-daily-factor-overview";
            public static readonly string GetAdjustmentToStaffHoursofBookingRequest = "api/booking/adjustment-staff-hour-of-booking-request";
            public static readonly string GetSubgroupBySearch = "api/sub-group/get-subgroup-information-by-search?SubgroupName={0}&Month={1}&Year={2}&TypeOfWork={3}" +
            ...
            public static readonly string GetKeyDeadlineSubgroupByBudget = "api/key-deadline/get-key-deadline-subgroup-by-budget";
        ...
        public static class CustomMessage
        {
            ...
            public static readonly string AddTagingSubgroupSuccess = "Subgroup <b class = 'red_color'>{0}</b> tagged successfully";
            ...
            public static readonly string MSG37 = "This Subgroup is the Primary Subgroup of another Budget Group. Please select a different Subgroup.";
            ...
            public static readonly string MSG67 = "You cannot approve Budget Groups whose APIC status is different from “Submitted”";
            public static readonly string MSG67S = "You cannot return Budget Groups whose APIC status is different from “Submitted”";
            ...
            public static readonly string MSG59 = "</br>Audit CY Budget updated successfully. The Budget Group will be submitted to EP to re-approve " +
            ...
            public static readonly string MSG78 = "Primary Entity of this Budget Group was deleted in source system. Please replace with new Primary Entity";
            public static readonly string MSG79 = "Primary Subgroup of this Budget Group was deleted in CRS. Please replace with new Primary Subgroup";
            public static readonly string MSG69 = "Are you sure you want to delete?";
            public static readonly string MSG80 = "This Budget Group is deleted by APIC. Please refresh the page to contitnue.";
            ...
            public static readonly string SubmitToAPICStatusError = "Budget Group is not Approved and BG APIC status is not blank or Returned";
            ...
            public static readonly string BudgetLocked = "Budget Group locked. {0}({1}) is currently editing the Budget Group.";
        ...
        {
            public static readonly string Audit = "Audit";
            public static readonly string AuditHoursReconciliationConstantsNotExisted = "Audit Hours Reconciliation Constants Not Existed !";
        }
        ...
        {
            public static readonly string BudgetGroupDoesNotSatisfyCondition = "Please select an Approved Budget Group that is recurring and is not a Lost Client to roll forward.";
            public static readonly string CanNotRollForwardRolling = "Can not roll forward this Budget group. Somebody is rolling";
            ...
            public static readonly string CanNotRollForwardEditing = "Cannot roll forward this Budget Group because another user is editing it.";
        }
